...
par(mfrow = c(2,2))
with(d,{
    plot(week,Global_active_power,type="l",xlab = "",ylab = "Global Active Power")
    plot(week,Voltage,type="l",ylab ="Voltage",xlab="datetime")
    plot(week,Sub_metering_1,type = "l",xlab = "",ylab = "Energy sub metering")
    lines(d$week,d$Sub_metering_2,col="red",type="l")
    lines(d$week,d$Sub_metering_3,col="blue",type="l")
    legend("topright",lty=1,col=c("black","red","blue"),legend=c("Sub_metering_1","Sub_metering_2","Sub_metering_3"))
    plot(week,Global_reactive_power,type="l",ylab = "Global_reactive_power",xlab="datetime")
})
dev.off()